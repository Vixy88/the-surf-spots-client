...
const recentPosts = [
  {
    id: 1,
    name: "How to choose the your board?",
    href: "https://www.surfnation.com.au/pages/how-to-choose-the-right-surfboard",
  },
  {
    id: 2,
    name: "How do I learn to surf?",
    href: "https://houseofsurf.co/learning-to-surf/",
  },
  {
    id: 3,
    name: "The Best Surf Spots in Algarve, Portugal",
    href: "https://www.surfertoday.com/surfing/the-best-surf-spots-in-portugal",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="/">
              <span className="sr-only">The Surf Spots</span>
              <img
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            ...
            <a
              href="#"
              className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-yellow-500 hover:opacity-70"
            >
              Sign up
            </a>
          </div>
          ...
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            <div className="pt-5 pb-6 px-5">
              <div className="flex items-center justify-between">
                ...
                <div className="-mr-2">
                  <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:bg-teal-500">
